...
**A broker.** Self-hosted (Mosquitto on a Raspberry Pi or a VPS) or third-party. The observer publishes to the broker; Waev subscribes and reads. The data stays with you — [bring-your-own-broker](/blog/setting-up-mosquitto-for-meshcore/) means you hold the keys. A served agency asking about data custody gets a simple answer: the data is on your broker.
