...
description: "Ham radio CERT EMCOMM mesh integration adds a data layer alongside VHF voice — digital messaging and node-status visibility that voice alone cannot provide, verified before the activation."
date: 2026-09-27
...
**A broker.** Self-hosted (Mosquitto on a Raspberry Pi or a VPS) or third-party. The observer publishes to the broker; Waev subscribes and reads. The data stays with you — [bring-your-own-broker](/blog/bring-your-own-broker/) means you hold the keys. A served agency asking about data custody gets a simple answer: the data is on your broker.
