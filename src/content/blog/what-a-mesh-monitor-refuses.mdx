...
faq:
  ...
  - q: "What is the difference between a privacy setting and a structural refusal?"
    a: "A privacy setting changes behavior at the application layer — it can be misconfigured, forgotten, or overridden by a future update. A structural refusal happens at the data model layer: the field was never written, so it cannot be retrieved, leaked, or accidentally re-enabled. Refusing to write a field is a stronger guarantee than hiding one by default."
...
Waev is a tool for network operators who need to know whether their infrastructure is working. [The evidence-based topology model](/blog/how-waev-reads-your-mesh/) means the map shows only what can be verified from enrolled observers. [The bring-your-own-broker architecture](/blog/can-waev-write-to-your-broker/) means the operator controls where data is stored. The refusal to collect identity, location, and personal device tracking is the third leg of the same stance: the network intelligence you need, without the surveillance infrastructure you don't.
