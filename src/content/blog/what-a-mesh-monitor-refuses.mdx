...
Waev is a tool for network operators who need to know whether their infrastructure is working. [The evidence-based topology model](/blog/how-waev-reads-your-mesh/) means the map shows only what can be verified from enrolled observers. [The bring-your-own-broker architecture](/blog/setting-up-mosquitto-for-meshcore/) means the operator controls where data is stored. The refusal to collect identity, location, and personal device tracking is the third leg of the same stance: the network intelligence you need, without the surveillance infrastructure you don't.
