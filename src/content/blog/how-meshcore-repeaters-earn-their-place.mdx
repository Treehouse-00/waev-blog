...
For more on how Waev's bring-your-own-broker model keeps that MQTT connection under operator control, see [Bring Your Own Broker](/blog/can-waev-write-to-your-broker/).
