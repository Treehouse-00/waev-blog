...
description: "How to measure SWR at 915 MHz using a NanoVNA: what the numbers mean, what a well-matched LoRa antenna looks like, and what to do when the dip is wrong."
date: 2026-06-09
...
For diagnosing range problems: if SWR is below 2.0, the antenna match is not your issue. Look at [path loss, SNR, and link margin](/blog/what-is-snr-lora/) instead.
