...
description: "SWR at 915 MHz with a NanoVNA: what the numbers mean, what a well-matched LoRa antenna looks like, and what to do when the dip is at the wrong frequency."
date: 2026-06-09
...
For diagnosing range problems: if SWR is below 2.0, the antenna match is not your issue. Look at [path loss, SNR, and link margin](/blog/measuring-snr-on-a-lora-mesh/) instead.
