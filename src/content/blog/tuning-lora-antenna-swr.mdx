...
The NanoVNA measures match (SWR) and impedance, not gain. A perfectly matched antenna with 0 dBi gain will cover less ground than a slightly mismatched antenna with 6 dBi gain. SWR is one input to the [link margin calculation](/blog/measuring-lora-link-margin/) — the antenna gain and placement are larger inputs.
