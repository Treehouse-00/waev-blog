...
The underlying principle here is the same one that governs [how packets become edges](/blog/how-meshcore-packets-become-a-live-map/): every line on the Live Map has a chain of custody. If the chain breaks — whether because of a misconfigured node, a spoofed prefix, or simply an unverified source — the line stays off the map. That's not a limitation. It's [the point of an evidence-based topology](/blog/how-waev-reads-your-mesh/).
