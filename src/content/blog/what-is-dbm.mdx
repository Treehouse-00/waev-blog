...
description: "What is dBm? It is an absolute radio power level referenced to 1 milliwatt — the unit behind every SNR reading, transmit spec, and antenna gain calculation you will encounter."
date: 2026-11-24
tags: ["primer", "signal"]
hero:
...
The moment these pieces connect — transmit power, cable loss, antenna gain, path loss, receiver sensitivity — you have a link budget. dBm is the unit that holds it all together.
