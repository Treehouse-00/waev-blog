...
A link at negative SNR that was positive six months ago is the one to prioritize. That's structural degradation — something in the environment changed — and it doesn't self-correct. The change in [Reading the Signal](/blog/what-is-snr-lora/) gives the full SNR interpretation framework; this series entry is specifically about the measurement method and where the numbers live in Waev.
