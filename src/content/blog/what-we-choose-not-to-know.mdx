...
If you're running a mesh network for a community — a neighborhood, a CERT team, a ham club — the people on that network are trusting you with more than just packet delivery. They trust that the infrastructure you built won't be turned against them: no location tracking, no usage profiles, no data quietly accumulating somewhere that they didn't sign up for. That trust is worth protecting, and it starts with what you choose not to collect.
