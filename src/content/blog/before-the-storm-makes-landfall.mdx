...
description: "Hurricane season mesh network prep begins six weeks out. Build a health data baseline now — it reveals marginal links while there's still time to fix them."
date: 2026-09-03
...
**SNR on the link to backbone.** A working MeshCore link generally holds above +7 dB in typical conditions. A node holding at +1 or +2 dB is technically alive but operating on borrowed margin. Any weather event, increased traffic, or minor power fluctuation can tip it over. Pull the time series in Outpost and look for whether that degradation is constant or shows a pattern — certain hours, certain conditions.
...
- Review 30-day Network Stats for every critical node. Flag any with watchlist periods, hop-count growth, or SNR below +7 dB consistently.
