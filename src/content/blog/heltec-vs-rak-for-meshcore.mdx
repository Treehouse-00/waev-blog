...
The V3 transmits at up to 21 dBm (about 125 mW). The V4, which shipped in late 2025, upgrades this to 28 dBm via an integrated power amplifier, adds 16 MB flash, and includes a solar connector and a GNSS interface header. Same footprint and pin layout as the V3; new builds should default to the V4.
