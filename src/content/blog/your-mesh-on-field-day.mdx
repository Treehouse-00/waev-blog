...
description: "ARRL Field Day is the year's biggest off-grid operating event — a rare window to watch your network absorb a surge of temporary stations in real time."
date: 2026-06-18
tags: ["field-notes", "community"]
author: "Waev"
ogImage: "/hero-field-day-og.jpg"
hero:
  src: "/hero-field-day.jpg"
  alt: "A hand-painted portable radio station on a folding table under a swirling painterly sky — the warm atmosphere of an off-grid operating event."
draft: false
faq:
  ...
  - q: "Do I need to configure anything special for Field Day?"
    a: "No. If you have an enrolled observer publishing to Waev's ingest, the Field Day traffic will appear automatically as it arrives. The only thing to check beforehand is that your observer is online and its connection to Waev is healthy."
...
Two things are worth watching in that stream. First, [the hop counts](/blog/measuring-hop-count-in-your-mesh/). A temporary station reaching your network at four or five hops is proof that your repeater chain is doing real work — something to feel good about. Second, the [SNR](/blog/what-is-snr-lora/) on those long paths. A +3 dB link is alive, but it's not margin you'd want to depend on. Neither of those observations calls for immediate action; they're the kind of data that becomes useful in the after-action review.
...
You don't need to do anything special to take advantage of this. If your observer is running and publishing, the data will be there. The best preparation is making sure everything is healthy before the weekend starts — observer online, MQTT connection clean, packets arriving.

The rest is just watching. And this particular weekend, watching is worth it.

---

Questions about getting your observer connected before Field Day, or something interesting in your data that doesn't fit the patterns above? [Reach out](mailto:admin@waev.app).
