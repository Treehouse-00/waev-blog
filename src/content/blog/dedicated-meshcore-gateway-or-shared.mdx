...
Whether the gateway is dedicated or shared, the data path is the same: the gateway node publishes MQTT records to [your broker](/blog/setting-up-mosquitto-for-meshcore/), Waev subscribes, and the map is built from what enrolled observers report.
