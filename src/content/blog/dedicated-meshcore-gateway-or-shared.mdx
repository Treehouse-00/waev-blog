...
Whether the gateway is dedicated or shared, the data path is the same: the gateway node publishes MQTT records to [your broker](/blog/bring-your-own-broker/), Waev subscribes, and the map is built from what enrolled observers report.
