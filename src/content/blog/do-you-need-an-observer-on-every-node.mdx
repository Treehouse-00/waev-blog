...
faq:
  ...
  - q: "Where should I place my observer?"
    a: "Place the observer where it can hear the most nodes. High ground with line-of-sight to your backbone repeaters is ideal. The observer needs internet connectivity — Wi-Fi, Ethernet, or a cellular modem — to publish its packet stream to Waev's ingest, so the chosen location also needs a reliable connection."
...
- **Internet connectivity.** The observer needs a reliable internet connection to publish its packet stream to [Waev's MQTT ingest](/blog/bring-your-own-broker/). A location with unreliable Wi-Fi produces an observer that drops out intermittently and leaves gaps in your monitoring record.
