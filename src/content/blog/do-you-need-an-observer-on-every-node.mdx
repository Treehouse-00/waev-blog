...
description: "How many mesh observers to enroll comes down to placement, not count. One well-placed observer can cover a whole network; poorly placed ones still leave gaps."
date: 2026-06-09
...
- **Internet connectivity.** The observer needs a reliable internet connection to push data to [your MQTT broker](/blog/setting-up-mosquitto-for-meshcore/). A location with unreliable Wi-Fi produces an observer that drops out intermittently and leaves gaps in your monitoring record.
