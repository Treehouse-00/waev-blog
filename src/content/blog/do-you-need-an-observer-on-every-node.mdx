...
description: "The question of how many mesh observers to enroll comes down to placement, not count. One well-sited observer can give you visibility into an entire network; a dozen poorly placed ones can still leave gaps."
date: 2026-11-22
...
- **Internet connectivity.** The observer needs a reliable internet connection to push data to [your MQTT broker](/blog/bring-your-own-broker/). A location with unreliable Wi-Fi produces an observer that drops out intermittently and leaves gaps in your monitoring record.
