...
- **Internet connectivity.** The observer needs a reliable internet connection to push data to your broker. A location with unreliable Wi-Fi produces an observer that drops out intermittently and leaves gaps in your monitoring record.
