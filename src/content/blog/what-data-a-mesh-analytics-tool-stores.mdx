...
The choice about what not to collect is made once, at the architecture level, and it determines what's possible from that point forward. You can't breach data that was never stored. You can't misuse identity that was scrubbed before it was written. The [privacy-by-default framing](/blog/what-a-mesh-monitor-refuses/) is the same one that governs [who holds your broker credentials](/blog/setting-up-mosquitto-for-meshcore/): the less the system knows, the more the operator controls.
