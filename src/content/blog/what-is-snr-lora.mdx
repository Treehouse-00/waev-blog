...
The +7 dB figure as a working target appears in Waev's Network Stats watchlist logic: paths consistently below +7 dB get flagged as marginal. It's the same figure used in the [Reading the Signal](/blog/what-is-snr-lora/) post, which covers how to use SNR alongside hop count to assess overall path quality.
