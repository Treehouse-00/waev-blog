...
<div class="callout">
<p><strong>TLDR:</strong> SNR in LoRa radio is the difference in decibels between the received signal power and the background noise floor. Higher is better. LoRa's chirp spread spectrum modulation can decode signals even when SNR is negative — below the noise floor — but reliable mesh operation generally needs +7 dB or more in typical conditions.</p>
</div>
