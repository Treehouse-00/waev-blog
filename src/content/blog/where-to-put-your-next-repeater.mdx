...
<div class="callout">
<p><strong>TL;DR.</strong> Do not guess where coverage drops. Use Waev to prove it. Find the gaps by looking for sharp cut-offs on the Live Map. Confirm the degradation by checking for nose-diving SNR in Network Stats. Then drive the edge of the suspect zone to watch live packets break. Put the mast where the data tells you.</p>
</div>
