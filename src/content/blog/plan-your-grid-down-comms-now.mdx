...
[When the grid actually goes down](/blog/cert-mesh-network-activation/), there isn't time to onboard a replacement. The time to make the plan robust is now, when the network is healthy and the calendar isn't constrained by an incident timeline.
