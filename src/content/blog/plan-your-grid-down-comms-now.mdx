...
[When the grid actually goes down](/blog/plan-your-grid-down-comms-now/), there isn't time to onboard a replacement. The time to make the plan robust is now, when the network is healthy and the calendar isn't constrained by an incident timeline.
