...
<div class="callout">
<p><strong>TLDR:</strong> SNR (Signal-to-Noise Ratio) measures how cleanly a signal arrives above the noise floor — higher is better, and the working target for a MeshCore link is roughly +7 dB or above in typical conditions. Hop count tells you how many radio legs a packet traveled; creeping hop counts are an early sign of path degradation. Together, they describe path quality — and a path is only as reliable as its weakest hop. Waev surfaces both in Live Packets, Network Stats, and Outpost.</p>
</div>
