...
description: "A LoRa mesh network setup tutorial for your first three MeshCore nodes — flash firmware, configure radio settings, and confirm packets in under an hour."
date: 2026-06-09
...
If you have Waev connected with an enrolled observer, those same SNR readings appear in Live Packets with timestamps and a persistent per-link history. That history is what lets you distinguish a transient interference event from a structurally weak link. [Reading the Signal](/blog/what-is-snr-lora/) covers how to interpret what you're seeing.
