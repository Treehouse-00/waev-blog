...
<div class="callout">
<p><strong>TLDR:</strong> A LoRa mesh network setup tutorial for MeshCore: flash two Companion nodes using the web flasher, pair them to the app, and confirm the link by watching for SNR readings. Then flash a third board as a Repeater and place it to extend your range. Four steps, no compiler required.</p>
</div>
