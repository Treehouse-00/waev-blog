...
description: "Understanding dBm from first principles: where the decibel came from, why radio power is logarithmic, and the physics that sets the noise floor."
date: 2026-06-13
tags: ["signal", "deep-dive"]
hero:
  src: "/hero-why-radio-speaks-in-decibels.jpg"
  alt: "A hand-painted close-up of a chambered nautilus shell in cross-section on a wooden workbench, its chambers spiraling outward in equal ratios, lit warmly from one side."
faq:
...
{/* ILLUSTRATION PROMPT: A warm flat hand-painted close-up of a chambered nautilus shell cut in cross-section, resting on a bare wooden workbench in soft directional light. Its chambers spiral outward in steadily growing steps — each a fixed ratio larger than the last — the logarithm made physical. One clear subject with quiet breathing room. No screens, no radio hardware, no graph paper, no glowing elements. Palette: warm amber and aged ivory with a restrained mother-of-pearl sheen, soft shadow falling to one side. Calm, studious, grounded mood. */}
