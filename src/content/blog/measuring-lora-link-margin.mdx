...
description: "Link margin tells you how much headroom your LoRa link has before it fails. This post explains how to calculate it, what values to target, and how to read it from your live SNR data."
date: 2026-10-20
...
Part 3 of the *measure your mesh* series. Earlier installments covered [SNR and hop count](/blog/reading-the-signal/) and [why packets disappear](/blog/why-mesh-packets-disappear/). This one covers link margin: the number that tells you how much headroom you actually have.
...
Waev's Outpost view shows per-node SNR history over days and weeks. The [baseline work described in the grid-down post](/blog/when-the-grid-goes-down/) is about building enough history to see these trends before they become failures.
