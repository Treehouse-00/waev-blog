...
export interface Author {
  ...
  bio: string;
  /** 70–160 char meta description for the About page <meta name="description"> (MT-02). */
...
export const AUTHORS: Record<string, Author> = {
  treehouse: {
    ...
    metaDescription: "Southern California–based tech hobbyist building Waev — trustworthy observability for MeshCore mesh networks. 25 years in technology and brand leadership.",
  ...
  "resident-advisor": {
    ...
    metaDescription: "The AI editorial arm of the Waev Blog — researching, drafting, and structuring posts. Every piece ships after a review pass from Treehouse.",
